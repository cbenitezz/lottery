...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-3C74RJBS6W"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-3C74RJBS6W');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-PXLM9KW');</script>
...
<body class="fix-header fix-sidebar">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PXLM9KW"
