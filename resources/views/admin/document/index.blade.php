...
@section('title', 'Listado Documentos')
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <table class="table table-sm table-hover table-bordered" id="doc_table">
                    <thead>
                       <tr>
                          <th>No.</th>
                          <th>Titulo</th>
...
<script>
  $(function() {
        ...
        columns: [
                 ...
                 { data: 'active', name: 'Publicado',orderable: false},
  ...
  $('#doc_table').on('click', '.btn-delete[data-remote]', function (e) {
    e.preventDefault();
    ...
    if (confirm('Esta Seguro de Eliminar?')) {
        $.ajax({
            ...
            $('#doc_table').DataTable().draw(false);
            });
    }
});
  </script>
